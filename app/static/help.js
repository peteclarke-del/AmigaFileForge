      ...
      <div class="help-layout">
        ...
        <div class="help-content">
          ...
          <section id="help-desktop">
            ...
            <div class="help-warning"><strong>Updating:</strong> choose <strong>About Amiga File Forge</strong> from the <strong>Help</strong> menu and press <strong>Check for Application Updates</strong>. A release package then offers <strong>Update to</strong> the new version, downloads the package for the same system, checks it against the release's <code>SHA256SUMS</code>, installs it with APT after the system asks for your password, and offers to restart. Nothing is installed while a floppy disk is being read or written. A checkout is sent to the release page instead: pull the new source and rerun the checkout installer when Python dependencies change. Working sessions remain under <code>~/.local/share/amiga-file-forge</code>, or the configured XDG data directory.</div>
          </section>
          ...
          <section id="help-project">
            ...
            <div class="help-note"><strong>Confirm the running build:</strong> close this handbook, then choose <strong>Help → About Amiga File Forge</strong>. The About dialog reports the version returned by the current server, the web or Linux desktop edition, filesystem engine, licence and project links. Its <strong>Check for Application Updates</strong> button asks GitHub for the latest release only when pressed.</div>
